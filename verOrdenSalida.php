...
<html>
	<head>
		<title>ORDEN DE SALIDA <?php echo $row['almacen']; ?></title>
		<meta charset="utf-8">
	...
	<body>
		...
		<table align="center" id="lista2" border="1">
			<tr>
				<th colspan="5"><p id="titleTable">ORDEN DE SALIDA <?php echo $row['almacen']; ?></p></th>
			</tr>
			<tr>
				...
				<td width="25%"><p align="center" style="color: red;">SAL-<?php echo $row['id_orden']; ?></p></td>
			</tr>
			<tr>
				<td><p align="right"><b>Cliente:</b></p></td>
