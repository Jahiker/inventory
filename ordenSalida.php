		...
		<form method="post" action="validar.php">
			<div>
				<table align="center" border="1" id="orden">
					<tr>
						<th colspan="2" id="titleTable">ORDEN DE SALIDA</th>
					</tr>
					<tr>
						<?php 
						...
						<td width="75%"><input type="date" name="fecha" id="campo" required="" value="<?php echo $fecha; ?>"><input type="hidden" name="tipo" value="salida"></td>
					</tr>
					<tr>
						<td width="25%"><p id="etiqueta">CLIENTE:</p></td>
						<td width="75%">
					...
					<tr>
						<td colspan="2"><input type="submit" name="registrar" id="registrar" value="CONTINUAR"><input type="reset" name="borrar" id="borrar" value="BORRAR"><input type="hidden" name="opcion" value="13"></td>
					</tr>
				</table>
			</div>
		</form>
