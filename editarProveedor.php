<?php  
	...
	$sql="SELECT * FROM proveedor WHERE id_proveedor='$_GET[pro]'";
		...
		<form method="post" action="validar.php">
			<div>
				<table align="center" border="0" id="regisTable">
					<tr>
						<th colspan="2" id="titleTable">EDITAR PROVEEDOR</th>
					</tr>
					<tr>
						<td>NOMBRE:</td>
						<td><input type="text" name="nombre" id="campo" placeholder="NOMBRE DE LA EMPRESA" required="" value="<?php echo $row['nombre']; ?>"><input type="hidden" name="id_proveedor" value="<?php echo $row['id_proveedor'] ?>"></td>
					</tr>
					<tr>
						<td>RIF:</td>
					...
					<tr>
						<th colspan="2"><input type="submit" name="registrar" id="registrar" value="MODIFICAR"><input type="hidden" name="opcion" value="10"></th>
					</tr>
				</table>
			</div>
		</form>
