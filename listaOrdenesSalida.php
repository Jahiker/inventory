<?php  
	...
	$sql="SELECT * FROM orden WHERE tipo='salida' ORDER BY id_orden DESC";
...
<html>
	...
	<body>	
		<table align="center" id="lista1" border="1">
			<tr>
				<th colspan="12">ORDENES DE SALIDA</th>
			</tr>
			<tr>
				<form method="post">
					<th colspan="12" height="35px"><input type="text" name="buscar" placeholder="Nombre del cliente">       <input type="submit" name="busqueda" value="Buscar"></th>
				</form>
			</tr>
			<tr>
				<th>NRO ORDEN</th>
			...
			<?php 
				if ($resultados==0) { ?>
					<tr>
						<th colspan="12" style="color: red;"><?php echo "NO SE HAN REALIZADO ORDENES DE SALIDA"; ?></th>
					</tr><?php
				} else {
						...
						if ($resultados1==0) { ?>
							...
							while ($row1=mysqli_fetch_array($query1)) { ?>
								<tr>
									...
									?>		
									<th><a href="inventarioSalida.php?pro=<?php print $row1[0] ?>"><img src="img/add-1-icon.png" id="modificar"></a></th>
									<th><a href="editarOrdenSalida.php?pro=<?php print $row1[0] ?>"><img src="img/Pencil512_44200.png" id="modificar"></a></th>
									<th><a href="verOrdenSalida.php?pro=<?php print $row1[0]; ?>"><img src="img/flash-live-system-ip-ver-1-3-icon-30.png" id="modificar"></a></th>
								</tr><?php
							}
						}
					} else {
							...
							<tr>
								...
								<?php
									if ($row['estatus']=='En Proceso') { ?>
										...
										<th><a href="inventarioSalida.php?pro=<?php print $row[0] ?>"><img src="img/add-1-icon.png" id="modificar"></a></th>
										<th><a href="editarOrdenSalida.php?pro=<?php print $row[0] ?>"><img src="img/Pencil512_44200.png" id="modificar"></a></th>
										<th><a href="verOrdenSalida.php?pro=<?php print $row[0]; ?>"><img src="img/flash-live-system-ip-ver-1-3-icon-30.png" id="modificar"></a></th><?php
									} else { ?>
