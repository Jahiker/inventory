		...
		<form method="post" action="validar.php">
			<div>
				<table align="center" border="1" id="orden">
					<tr>
						<th colspan="2" id="titleTable">EDITAR ORDEN</th>
					</tr>
					<tr>
						<?php 
					...
					<tr>
						<th colspan="2"><input type="submit" name="continuar" id="continuar" value="CONTINUAR"><input type="hidden" name="opcion" value="14"></th> 
					</tr>
				</table>
			</div>
		</form>
